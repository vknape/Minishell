...
INFILE=tester/test_files/infile.txt
INFILE_NO=tester/test_files/infile_no_permissions.txt
OUTFILE1=tester/vbash.txt
OUTFILE11=tester/vbash11.txt
OUTFILE2=tester/vmini.txt
OUTFILE22=tester/vmini22.txt
...
tester 'export var=hello\nunset var \necho $var'
tester 'export var=hello var1=helloo\n unset var var1\n echo $var $var1'
...
printf "\n\033[1m\033[36mPermission TESTS\n"
tester "cat $INFILE_NO"
tester "cat < $INFILE_NO"
tester "cat < $INFILE < $INFILE_NO"
tester "cat < $INFILE_NO < $INFILE"
touch $OUTFILE11
chmod 000 $OUTFILE11
# chmod 000 $OUTFILE22
tester "ls > $OUTFILE11"
tester "ls > tester/bredir.txt > $OUTFILE11"
tester "ls > $OUTFILE11 > tester/bredir.txt"
